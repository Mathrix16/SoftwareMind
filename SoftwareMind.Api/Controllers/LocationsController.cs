...
public sealed class LocationsController : ControllerBase
{
    ...
    /// <response code = "400">Desk had one or more active reservations and removal was not possible or some
    /// input body errors occurred</response>
    ...
    /// <response code = "400">Given desk is not available or some input body errors occurred or dates are incorrect or
    /// reservation was for period longer than 7 days </response>
    /// <response code = "404">Desk or location with given id was not found</response>
    ...
    /// <response code = "400">Given desk is not available or some input body errors occurred or dates are incorrect or
    /// reservation was for period longer than 7 days or it is less time than 24 hours till reservation start </response>
    /// <response code = "404">Desk or location with given id was not found</response>
